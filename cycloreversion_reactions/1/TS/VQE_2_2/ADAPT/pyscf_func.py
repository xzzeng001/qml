...
def init_scf(geometry, basis="sto-3g", spin=0,charge=0,
...
implemented.".format(fermion_to_qubit_mapping))
    ...
    return molecule, n_qubits, n_orb, n_elec, n_orb_occ, occ_indices_spin, \
...
#        = init_scf_old(geometry, with_fci, basis, spin,charge)
    molecule, n_qubits, n_orb, n_elec, n_orb_occ, occ_indices_spin, \
               hamiltonian_fermOp, hamiltonian_qubitOp,e\
         = init_scf(geometry, basis, spin, charge,
             freeze_indices_spatial=[],
             active_indices_spatial=[],
             run_fci = True,
...
#    print("n_qubits, n_orb, n_orb_occ, occ_indices_spin\n",n_qubits, n_orb, n_orb_occ, occ_indices_spin)
    return e, n_qubits, n_orb, n_elec, n_orb_occ, occ_indices_spin, hamiltonian_qubitOp_reduced
